...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e2fa4aec.test.akuity",
	...
	if err := (&namespaceextenitioncontroller.NamespaceClassReconciler{
	...
	if err := (&corecontroller.NamespaceReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "core-namespace")
		os.Exit(1)
	}
